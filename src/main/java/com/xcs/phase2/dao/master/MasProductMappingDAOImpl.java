...
public class MasProductMappingDAOImpl extends MasterExt implements MasProductMappingDAO {
    ...
    public List<ProductMapping> MasProductMappinggetByKeyword(MasProductMappinggetByKeywordReq req) {
        ...
        StringBuilder sqlBuilder = new StringBuilder()
                .append("  SELECT " +
                        ...
                        "  MAS_PRODUCT_SUBTYPE.PRODUCT_SUBTYPE_NAME," +
                        "  MAS_PRODUCT_MAPPING.PRODUCT_SUBSETTYPE_ID," +
                        "  MAS_PRODUCT_SUBSETTYPE.PRODUCT_SUBSETTYPE_NAME," +
                        ...
                        "  MAS_PRODUCT_TAXDETAIL.TAX_VALUE," +
                        "  MAS_PRODUCT_TAXDETAIL.TAX_VOLUMN," +
                        "  MAS_PRODUCT_TAXDETAIL.TAX_VOLUMN_UNIT," +
                        "  MAS_PRODUCT_TAXDETAIL.IS_TAX_VALUE," +
                        "  MAS_PRODUCT_TAXDETAIL.IS_TAX_VOLUMN," +
                        ...
                        "        MAS_PRODUCT_SUBTYPE.PRODUCT_SUBTYPE_NAME || " +
                        "        MAS_PRODUCT_SUBSETTYPE.PRODUCT_SUBSETTYPE_NAME " +
                        "    ) LIKE LOWER(REPLACE('%"+req.getTEXT_SEARCH()+"%',' ',''))");
    ...
    public List<ProductMapping> MasProductMappinggetByConAdv(MasProductMappinggetByConAdvReq req) {
        ...
        if(!StringUtils.isEmpty(req.getPRODUCT_NAME_DESC())){
            sqlBuilder.append(" AND LOWER (MAS_PRODUCT_MAPPING.PRODUCT_NAME_DESC) LIKE LOWER(REPLACE('%"+req.getPRODUCT_NAME_DESC()+"%',' ','')) ");
        }
    ...
    public MasProductMapping MasProductMappinggetByCon(MasProductMappinggetByConReq req) {
        ...
        return getJdbcTemplate().query(sqlBuilder.toString(), new ResultSetExtractor<MasProductMapping>() {
            ...
            public MasProductMapping extractData(ResultSet rs) throws SQLException,
                    DataAccessException {
                if (rs.next()) {
    ...
    public Boolean MasProductMappingupdAll(MasProductMapping req) {
        ...
        StringBuilder sqlBuilder = new StringBuilder()
                .append("UPDATE MAS_PRODUCT_MAPPING SET "
    ...
    public Boolean MasProductMappingupdDelete(MasProductMappingupdDeleteReq req) {
        ...
        StringBuilder sqlBuilder1 = new StringBuilder().append("UPDATE MAS_PRODUCT_MAPPING SET IS_ACTIVE = '0' WHERE PRODUCT_MAPPING_ID = '"+req.getPRODUCT_MAPPING_ID()+"' ");
