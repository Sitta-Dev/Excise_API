...
public class ProveListDAOImpl extends ProveExt implements ProveListDAO {
	...
	public List<ProveList> ProveListgetByKeyword(ProveListgetByKeywordReq req) {
		...
		StringBuilder sqlBuilder = new StringBuilder().append("with temp as (" + "    Select distinct"
				...
				+ "    OCCURRENCE_DATE," + "    INDICTMENT_ID," + "    ARREST_STAFF_NAME," +
                        "    LAWSUIT_TYPE," +
                        "    LAWSUIT_END," +
				"    SUBSECTION_NAME," + "    GUILTBASE_NAME," + "    SUB_DISTRICT_NAME_TH,"
				...
				+ "    PROVE_OPERATION_DEPT_LEVEL," + "    PROVE_OPERATION_UNDER_DEPT_CODE,"
				+ "    PROVE_OPERATION_UNDER_DEPT_NAME," + "    PROVE_OPERATION_UNDER_DEPT_LEVEL,"
				+ "    PROVE_OPERATION_WORK_DEPT_CODE," + "    PROVE_OPERATION_WORK_DEPT_NAME,"
				+ "    PROVE_OPERATION_WORK_DEPT_LEVEL," + "    PROVE_OPERATION_OFFICE_CODE,"
				+ "    PROVE_OPERATION_OFFICE_NAME," + "    PROVE_OPERATION_OFFICE_SHORT_NAME,"
				...
				"        SUBSECTION_NAME," + "        GUILTBASE_NAME," + "        SUB_DISTRICT_NAME_TH,"
				+ "        SUB_DISTRICT_NAME_EN," + "        DISTRICT_NAME_TH," + "        DISTRICT_NAME_EN,"
				+ "        PROVINCE_NAME_TH," + "        PROVINCE_NAME_EN," + "        LAWSUIT_ID,"
				+ "        LAWSUILT_NO," + "        LAWSUIT_DATE," + "        IS_LAWSUIT,"
				...
				+ "        PROVE_OPERATION_UNDER_DEPT_CODE," + "        PROVE_OPERATION_UNDER_DEPT_NAME,"
				+ "        PROVE_OPERATION_UNDER_DEPT_LEVEL," + "        PROVE_OPERATION_WORK_DEPT_CODE,"
				+ "        PROVE_OPERATION_WORK_DEPT_NAME," + "        PROVE_OPERATION_WORK_DEPT_LEVEL,"
				+ "        PROVE_OPERATION_OFFICE_CODE," + "        PROVE_OPERATION_OFFICE_NAME,"
				+ "        PROVE_OPERATION_OFFICE_SHORT_NAME," + "        RECEIVE_OFFICE_NAME," + "        PROVE_STATUS"
				+ "    ) AS LAWBREAKER_ID" + "   from temp" + "   GROUP BY" + "        ARREST_ID,"
				+ "        ARREST_CODE," + "        ARREST_DATE," + "        OCCURRENCE_DATE,"
				+ "        INDICTMENT_ID," + "        ARREST_STAFF_NAME," +
                        "        LAWSUIT_TYPE," +
                        "        LAWSUIT_END," +
				"        SUBSECTION_NAME," + "        GUILTBASE_NAME," + "        SUB_DISTRICT_NAME_TH,"
				+ "        SUB_DISTRICT_NAME_EN," + "        DISTRICT_NAME_TH," + "        DISTRICT_NAME_EN,"
				...
				+ "        PROVE_OPERATION_WORK_DEPT_NAME," + "        PROVE_OPERATION_WORK_DEPT_LEVEL,"
				+ "        PROVE_OPERATION_OFFICE_CODE," + "        PROVE_OPERATION_OFFICE_NAME,"
				+ "        PROVE_OPERATION_OFFICE_SHORT_NAME," + "        RECEIVE_OFFICE_NAME,"
				+ "        PROVE_STATUS");
	...
	public List<ProveList> ProveListgetByConAdv(final ProveListgetByConAdvReq req) {
		...
		if (req.getLAWBREAKER_STAFF_NAME() != null && !"".equals(req.getLAWBREAKER_STAFF_NAME())) {
			sqlBuilder.append(" AND " + " ("
					+ "  LOWER(OPS_ARREST_LAWBREAKER.TITLE_NAME_TH||OPS_ARREST_LAWBREAKER.FIRST_NAME||OPS_ARREST_LAWBREAKER.LAST_NAME||OPS_ARREST_LAWBREAKER.COMPANY_NAME) LIKE LOWER(REPLACE('%"
					+ req.getLAWBREAKER_STAFF_NAME() + "%',' ',''))"
					+ "  OR LOWER(OPS_ARREST_LAWBREAKER.TITLE_NAME_EN||OPS_ARREST_LAWBREAKER.FIRST_NAME||OPS_ARREST_LAWBREAKER.LAST_NAME||OPS_ARREST_LAWBREAKER.COMPANY_NAME) LIKE LOWER(REPLACE('%"
					+ req.getLAWBREAKER_STAFF_NAME() + "%',' ',''))"
					+ "  OR LOWER(OPS_ARREST_LAWBREAKER.TITLE_SHORT_NAME_TH||OPS_ARREST_LAWBREAKER.FIRST_NAME||OPS_ARREST_LAWBREAKER.LAST_NAME||OPS_ARREST_LAWBREAKER.COMPANY_NAME) LIKE LOWER(REPLACE('%"
					+ req.getLAWBREAKER_STAFF_NAME() + "%',' ',''))"
		...
		if (req.getARREST_OFFICE_NAME() != null && !"".equals(req.getARREST_OFFICE_NAME())) {
			sqlBuilder.append(
					" AND LOWER(MAS_SUB_DISTRICT.SUB_DISTRICT_NAME_TH||MAS_DISTRICT.DISTRICT_NAME_TH||MAS_PROVINCE.PROVINCE_NAME_TH) LIKE LOWER(REPLACE('%"
		...
		if (req.getLAWSUIT_NO_YEAR() != null && !"".equals(req.getLAWSUIT_NO_YEAR())) {
			sqlBuilder.append(
					" AND (to_number(TO_CHAR(OPS_LAWSUIT.LAWSUIT_NO_YEAR,'YYYY', 'NLS_CALENDAR=''THAI BUDDHA'' NLS_DATE_LANGUAGE=THAI')) = '"
		...
		if (req.getPROVE_NO_YEAR() != null && !"".equals(req.getPROVE_NO_YEAR())) {
			sqlBuilder.append(
					" AND (to_number(TO_CHAR(OPS_PROVE.PROVE_NO_YEAR,'YYYY', 'NLS_CALENDAR=''THAI BUDDHA'' NLS_DATE_LANGUAGE=THAI'))= '"
